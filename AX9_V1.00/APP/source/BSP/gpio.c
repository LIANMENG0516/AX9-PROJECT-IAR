...
{	
    ...
    //BAT2_SMBUS_C
    Gpio_Init(BAT2_SMBUS_C_PORT, BAT2_SMBUS_C_PIN, GPIO_Mode_OUT, GPIO_OType_OD, GPIO_PuPd_NOPULL);
    ...
    //BAT2_SMBUS_D   
    Gpio_Init(BAT2_SMBUS_D_PORT, BAT2_SMBUS_D_PIN, GPIO_Mode_OUT, GPIO_OType_OD, GPIO_PuPd_NOPULL);
    ...
    //BAT1_SMBUS_D
    Gpio_Init(BAT1_SMBUS_D_PORT, BAT1_SMBUS_D_PIN, GPIO_Mode_OUT, GPIO_OType_OD, GPIO_PuPd_NOPULL);
    
    //BAT1_SMBUS_C 
    Gpio_Init(BAT1_SMBUS_C_PORT, BAT1_SMBUS_C_PIN, GPIO_Mode_OUT, GPIO_OType_OD, GPIO_PuPd_NOPULL);
